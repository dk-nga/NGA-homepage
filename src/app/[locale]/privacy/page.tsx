...
export const metadata: Metadata = {
  title: "개인정보 처리방침 | 넥스트젠AI",
  description: "넥스트젠AI 개인정보 처리방침. 고객 정보 보호 및 관리 정책.",
  ...
  return (
    <LegalPage title="개인정보처리방침">
      <div className="prose prose-lg max-w-none text-foreground/80">
        <p className="mb-6 text-xl font-semibold">주식회사 넥스트젠에이아이</p>
        <hr className="my-6" />
        <p>
          주식회사 <strong>넥스트젠에이아이</strong>(이하 <strong>&quot;회사&quot;</strong>)는
        ...
        <ul className="list-disc space-y-1 pl-6">
          ...
          <li>소속 및 직책: 주식회사 넥스트젠에이아이 / 대표</li>
          <li>
            연락처(이메일):{" "}
            <a href="mailto:contact@nextgenai.kr" className="text-primary hover:underline">
              contact@nextgenai.kr
            </a>
          </li>
        </ul>
        <hr className="my-6" />
