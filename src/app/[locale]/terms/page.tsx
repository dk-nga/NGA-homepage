...
export const metadata: Metadata = {
  title: "서비스 이용약관 | 넥스트젠AI",
  description: "넥스트젠AI 서비스 이용약관. 서비스 이용에 관한 권리 및 의무사항.",
  ...
  return (
    <LegalPage title="서비스 이용약관">
      <div className="prose prose-sm max-w-none text-sm text-foreground/80">
        <p className="mb-4 font-medium">주식회사 넥스트젠에이아이</p>
        <p className="mb-6 text-xs text-foreground/60">
          본 서비스 이용약관(이하 &quot;본 약관&quot;)은 주식회사 넥스트젠에이아이(이하
