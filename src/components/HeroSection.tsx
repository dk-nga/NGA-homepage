          ...
          <div className="flex min-h-[calc(100vh-12rem)] flex-col gap-8 lg:min-h-0">
            ...
            >
              <h1 className="text-xl font-black leading-tight sm:text-2xl md:text-4xl md:leading-[1.15] lg:text-5xl">
                <span>
                  {t("hero.title1")}{" "}
                  <motion.span
                    className="inline-block bg-gradient-to-r from-[#8D36EB] to-[#165CFF] bg-clip-text text-transparent"
            ...
            >
              <button
                ...
                className="rounded-full bg-gradient-to-r from-[#8D36EB] to-[#165CFF] px-5 py-2.5 text-sm font-semibold text-white transition-all hover:scale-105 hover:opacity-90 md:px-8 md:py-4 md:text-base"
              >
                {t("hero.cta1")}
              </button>
              <button
                ...
                className="rounded-full border-2 border-border bg-background px-5 py-2.5 text-sm font-semibold transition-all hover:scale-105 hover:border-[#8D36EB]/50 md:px-8 md:py-4 md:text-base"
              >
                {t("hero.cta2")}
              </button>
            </motion.div>
