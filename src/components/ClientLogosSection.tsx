...
export function ClientLogosSection() {
  ...
  return (
    <section className="relative overflow-hidden overflow-x-hidden bg-gradient-to-b from-[#0a0a1a] via-[#0d0d24] to-[#0d0d24] py-24 md:py-28">
      <div
        className="absolute h-64 w-64 rounded-full bg-gradient-to-r from-[#8D36EB]/40 to-[#165CFF]/40 blur-3xl"
        style={{ left: "5%", top: "10%" }}
      />
      <div
        className="absolute h-48 w-48 rounded-full bg-gradient-to-r from-[#165CFF]/30 to-[#8D36EB]/30 blur-3xl"
      ...
      <div className="container relative z-10 mx-auto overflow-hidden px-4 md:px-6">
        ...
        >
          <p className="mb-1 text-xs text-gray-400 md:mb-2 md:text-lg">{t("clients.subtitle")}</p>
          ...
          <img src={nextgenLogo.src} alt="NextGen AI" className="mx-auto h-6 md:h-14" />
        </motion.div>
