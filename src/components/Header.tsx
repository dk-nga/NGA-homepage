        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <motion.button
              ...
              className="hidden rounded-lg bg-gradient-to-r from-[#8D36EB] to-[#165CFF] px-6 py-2.5 text-base font-semibold text-white transition-opacity hover:opacity-90 md:block"
            ...
            <div className="flex items-center gap-2 md:hidden">
              <button
                onClick={openContactWidget}
                className="rounded-lg bg-gradient-to-r from-[#8D36EB] to-[#165CFF] px-4 py-2 text-sm font-semibold text-white"
              >
                {t("nav.contact")}
              </button>
