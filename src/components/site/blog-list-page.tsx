...
const heroBlobs = [
  {
    ...
    style: {
      ...
      left: "-10%",
      top: "-20%",
      background: "radial-gradient(ellipse at center, rgba(141, 54, 235, 0.08) 0%, transparent 70%)",
    },
    animate: {
      x: [0, 20, 0],
      scale: [1, 1.05, 1],
  ...
  },
  {
    ...
    style: {
      ...
      right: "-15%",
      top: "0%",
      background: "radial-gradient(ellipse at center, rgba(22, 92, 255, 0.1) 0%, transparent 65%)",
    },
    animate: {
      x: [0, -15, 0],
      y: [0, 10, 0],
  ...
  },
  {
    ...
    style: {
      ...
      right: "20%",
      bottom: "-20%",
      background: "radial-gradient(ellipse at center, rgba(100, 200, 230, 0.12) 0%, transparent 60%)",
    },
    animate: {
      scale: [1, 1.1, 1],
      opacity: [0.8, 1, 0.8],
  ...
  },
  {
    ...
    style: {
      ...
      left: "30%",
      top: "-10%",
      background: "radial-gradient(ellipse at center, rgba(180, 140, 255, 0.06) 0%, transparent 55%)",
    },
    animate: {
      y: [0, 15, 0],
    },
      ...
      <div className="min-h-screen bg-background">
        ...
        <section className="relative pt-20 md:pt-[72px]">
          <div
            ...
            style={{
              background: "linear-gradient(135deg, #F0F7FC 0%, #E8F2FA 40%, #F5F0FB 100%)",
            }}
          >
                      ...
                      <div className="space-y-2 md:space-y-3">
                        ...
                        <h2
                          className={cn(
                            ...
                            "group-hover:bg-gradient-to-r group-hover:from-[#8D36EB] group-hover:to-[#165CFF] group-hover:bg-clip-text group-hover:text-transparent",
                          )}
                        >
                          {post.title}
                        </h2>
                        ...
                        <div className="hidden items-center gap-2 text-sm font-medium transition-all group-hover:gap-3 md:flex">
                          ...
                          <ArrowRight className="h-4 w-4 text-[#8D36EB] transition-colors group-hover:text-[#165CFF]" />
                        </div>
                      </div>
                    </Link>
                  </motion.article>
