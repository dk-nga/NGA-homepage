    ...
    <div className="min-h-screen bg-white text-foreground overflow-x-hidden">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-b from-[#f8f9fc] via-[#f5f6fa] to-[#f0f2f8]">
        ...
        <div className="absolute inset-0">
          <div className="absolute top-0 left-1/3 w-96 h-96 bg-gradient-to-br from-[#8D36EB]/5 to-transparent rounded-full blur-3xl" />
          <div className="absolute bottom-0 right-1/4 w-80 h-80 bg-gradient-to-br from-[#165CFF]/5 to-transparent rounded-full blur-3xl" />
        </div>
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          >
            {/* Eyebrow Badge */}
            <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-white/80 backdrop-blur-sm rounded-full border border-[#8D36EB]/20 shadow-sm mb-4 md:mb-6">
              <img src={nextgenSymbol.src} alt="NextGenAI" className="h-4 w-4 md:h-5 md:w-5" />
              <span className="text-xs md:text-sm font-semibold text-transparent bg-clip-text bg-gradient-to-r from-[#8D36EB] to-[#165CFF]">
                AX Partners Program
              </span>
            </div>
            ...
            <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold leading-tight mb-3 md:mb-4 text-slate-900">
              {t('axp.hero.h1.line1')}
              <br />
              {t('axp.hero.h1.line2.before')}<span className="relative inline-block"><span className="absolute inset-0 bg-gradient-to-r from-[#8D36EB]/20 to-[#165CFF]/20 -skew-x-3 rounded"></span><span className="relative text-transparent bg-clip-text bg-gradient-to-r from-[#8D36EB] to-[#165CFF]">{t('axp.hero.h1.highlight')}</span></span>{t('axp.hero.h1.line2.after')}
            </h1>
            ...
            {/* Sub Copy - smaller */}
            <p className="text-xs md:text-sm font-semibold text-[#8D36EB] mb-3 md:mb-4">
              {t('axp.hero.subCopy')}
            </p>
            ...
            <div className="flex flex-wrap gap-2 mb-4 md:mb-6">
              {[t('axp.hero.keyPoint1'), t('axp.hero.keyPoint2'), t('axp.hero.keyPoint3')].map((point) => (
                <div key={point} className="flex items-center gap-1.5 text-[10px] md:text-xs text-slate-700 bg-white/60 backdrop-blur-sm px-2 py-1 rounded-full border border-slate-200">
                  <Check className="h-3 w-3 text-[#8D36EB]" />
                  {point}
                </div>
              ))}
            </div>
        ...
        >
          <ChevronDown className="h-8 w-8 text-[#8D36EB]/50" />
        </motion.div>
      </section>
        ...
        <div className="relative z-10 max-w-6xl mx-auto">
          ...
          >
            <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold mb-4 text-white leading-tight">
              ...
              <span className="relative inline-block px-2 md:px-3 py-0.5 bg-gradient-to-r from-[#8D36EB] to-[#165CFF] rounded-lg">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-5 gap-3 lg:gap-5 mb-8 md:mb-12">
            {solutionCards.map((item, index) => (
              <motion.div
                ...
                transition={{ delay: index * 0.1 }}
              >
                <div className="w-10 h-10 lg:w-12 lg:h-12 bg-gradient-to-br from-[#8D36EB]/30 to-[#165CFF]/30 rounded-xl flex items-center justify-center mb-3 lg:mb-4 group-hover:from-[#8D36EB]/50 group-hover:to-[#165CFF]/50 transition-colors">
      ...
      <section className="relative py-24 md:py-32 px-4 bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900 overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none overflow-hidden">
          ...
          >
            <div className="absolute inset-0 rounded-full bg-gradient-to-br from-[#8D36EB]/20 to-[#165CFF]/10 blur-3xl" />
            <div className="absolute inset-8 rounded-full border-2 border-[#8D36EB]/30" />
            <div className="absolute inset-16 rounded-full border border-[#165CFF]/20" />
          </motion.div>
          ...
          >
            <div className="absolute inset-0 rounded-full bg-gradient-to-tr from-[#165CFF]/15 to-[#8D36EB]/10 blur-3xl" />
            <div className="absolute inset-12 rounded-full border-2 border-[#165CFF]/25" />
          </motion.div>
          ...
          <svg className="absolute inset-0 w-full h-full" viewBox="0 0 1200 800" preserveAspectRatio="none">
            ...
            <defs>
              <linearGradient id="thinkingLineGradient1" x1="0%" y1="0%" x2="100%" y2="0%">
                <stop offset="0%" stopColor="#8D36EB" stopOpacity="0" />
                <stop offset="50%" stopColor="#8D36EB" stopOpacity="1" />
                <stop offset="100%" stopColor="#165CFF" stopOpacity="0" />
              </linearGradient>
              <linearGradient id="thinkingLineGradient2" x1="0%" y1="0%" x2="100%" y2="0%">
                <stop offset="0%" stopColor="#165CFF" stopOpacity="0" />
                <stop offset="50%" stopColor="#165CFF" stopOpacity="1" />
                <stop offset="100%" stopColor="#8D36EB" stopOpacity="0" />
              </linearGradient>
            </defs>
          </svg>
        </div>
        ...
        <div className="relative z-10 max-w-6xl mx-auto">
          ...
          >
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <span className="w-2 h-2 bg-gradient-to-r from-[#8D36EB] to-[#165CFF] rounded-full animate-pulse" />
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-4 md:mb-6 text-white leading-tight">
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#8D36EB] via-[#A855F7] to-[#165CFF]">
                NextGenAI Thinking Process
              </span>
            </h2>
            ...
            <div className="text-center">
              <p className="text-sm md:text-2xl text-white/90 leading-relaxed">
                ...
                <span className="relative inline-block mt-1 md:mt-2">
                  <span className="text-base md:text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#8D36EB] to-[#165CFF]">
                    {t('axp.thinking.philosophy3')}
                  </span>
                  <span className="absolute -bottom-1 md:-bottom-2 left-0 right-0 h-0.5 md:h-1 bg-gradient-to-r from-[#8D36EB] to-[#165CFF] rounded-full" />
                </span>
          ...
          <div className="relative grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-6">
            {[
              ...
              >
                {/* Glow Effect */}
                <div className="absolute -inset-1 bg-gradient-to-r from-[#8D36EB] to-[#165CFF] rounded-xl opacity-0 group-hover:opacity-50 blur-xl transition-opacity duration-500" />
                ...
                <div className="relative bg-white/10 backdrop-blur-md border border-white/20 rounded-xl overflow-hidden hover:bg-white/15 hover:border-white/30 transition-all duration-300 h-full">
                  {/* Step Number */}
                  <div className="absolute top-2 right-2 z-10 w-6 h-6 md:w-7 md:h-7 bg-gradient-to-r from-[#8D36EB] to-[#165CFF] rounded-md flex items-center justify-center text-white text-[10px] md:text-xs font-bold shadow-lg shadow-[#8D36EB]/30">
      ...
      <section className="relative py-24 md:py-32 px-4 bg-gradient-to-br from-slate-50 via-white to-purple-50/30 overflow-hidden">
        ...
        <div className="absolute inset-0">
          <div className="absolute inset-0 opacity-[0.03]">
            <div className="absolute inset-0" style={{
              backgroundImage: `radial-gradient(circle at 1px 1px, #8D36EB 1px, transparent 0)`,
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <div className="inline-flex items-center gap-2 bg-gradient-to-r from-[#8D36EB]/10 to-[#165CFF]/10 border border-[#8D36EB]/20 rounded-full px-4 py-2 mb-6">
              <span className="text-sm font-medium text-[#8D36EB]">Work Classification Map</span>
            </div>
            ...
            <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-foreground mb-4 leading-tight">
              ...
              <span className="relative inline-block">
                ...
                <motion.span 
                  className="absolute inset-0 bg-gradient-to-r from-[#8D36EB] to-[#165CFF] rounded-lg -skew-x-2"
                  initial={{ scaleX: 0 }}
          ...
          <div className="relative max-w-5xl mx-auto mb-16">
            ...
            <div className="hidden md:flex absolute -left-16 top-1/2 -translate-y-1/2 items-center gap-2">
              <div className="flex flex-col items-center">
                <div className="w-px h-16 bg-gradient-to-b from-transparent via-[#8D36EB]/30 to-transparent" />
            ...
            <div className="hidden md:block absolute -bottom-12 left-1/2 -translate-x-1/2">
              <div className="flex items-center gap-2">
                <div className="w-16 h-px bg-gradient-to-r from-transparent via-[#165CFF]/30 to-transparent" />
          ...
          >
            <div className="flex items-center gap-3 mb-6">
              <div className="w-10 h-10 bg-gradient-to-r from-[#8D36EB] to-[#165CFF] rounded-xl flex items-center justify-center">
          ...
          >
            <div className="inline-block">
              ...
              <p className="text-base md:text-lg font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#8D36EB] to-[#165CFF]">
      ...
      <section className="relative py-24 md:py-32 px-4 bg-gradient-to-b from-slate-50 to-white overflow-hidden">
        <div className="max-w-6xl mx-auto">
          ...
          >
            <div className="inline-flex items-center gap-2 bg-gradient-to-r from-[#8D36EB]/10 to-[#165CFF]/10 border border-[#8D36EB]/20 rounded-full px-4 py-2 mb-6">
              <span className="text-sm font-medium text-[#8D36EB]">{t('axp.12week.badge')}</span>
            </div>
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-4 text-foreground leading-tight">
              {t('axp.12week.title1')}<span className="text-transparent bg-clip-text bg-gradient-to-r from-[#8D36EB] to-[#165CFF]">{t('axp.12week.title2')}</span>{t('axp.12week.title3')}
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4">
            ...
            {/* Step 3 - CORE */}
            <motion.div
              className="group relative bg-gradient-to-br from-[#8D36EB]/5 to-[#165CFF]/5 border-2 border-[#8D36EB]/30 rounded-xl overflow-hidden shadow-md hover:shadow-2xl hover:z-10 transition-all duration-500"
              initial={{ opacity: 0, y: 30 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              transition={{ delay: 0.2 }}
            >
              ...
              <div className="absolute top-1 left-1/2 -translate-x-1/2 z-20">
                <div className="bg-gradient-to-r from-[#8D36EB] to-[#165CFF] text-white px-2 py-0.5 rounded-full text-[8px] font-bold shadow-md">
              ...
              <div className="relative h-32 overflow-hidden">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-white via-white/50 to-transparent" />
                <div className="absolute top-2 left-2">
                  <div className="w-8 h-8 bg-gradient-to-br from-[#8D36EB] to-[#165CFF] rounded-lg flex items-center justify-center text-white font-bold text-xs shadow-lg">
                    03
                  </div>
                </div>
                <div className="absolute top-2 right-2">
                  <span className="text-[10px] font-semibold text-[#8D36EB] bg-white/90 backdrop-blur-sm px-2 py-0.5 rounded-full">{t('axp.12week.step3.week')}</span>
                </div>
              </div>
              ...
              <div className="p-3">
                ...
                <span className="text-[10px] font-medium text-[#8D36EB] bg-[#8D36EB]/10 px-2 py-0.5 rounded-full">{t('axp.12week.step3.badge')}</span>
              </div>

              {/* Hover Detail Overlay */}
              <div className="absolute inset-0 bg-white/95 backdrop-blur-sm p-4 opacity-0 group-hover:opacity-100 transition-all duration-300 flex flex-col justify-center">
                <div className="w-8 h-8 bg-gradient-to-br from-[#8D36EB] to-[#165CFF] rounded-lg flex items-center justify-center text-white font-bold text-xs mb-3">
                  03
                </div>
                <h3 className="text-sm font-bold text-foreground mb-1">{t('axp.12week.step3.title')}</h3>
                ...
                <div className="bg-[#8D36EB]/10 border border-[#8D36EB]/20 rounded-md p-2 mt-auto">
                  <p className="text-[10px] text-[#8D36EB]">{t('axp.12week.step3.output')}</p>
                </div>
              </div>
            </motion.div>
          ...
          <div className="mt-8 flex justify-center">
            <motion.div
              className="bg-gradient-to-r from-[#8D36EB] to-[#165CFF] rounded-xl px-6 py-4 text-center text-white"
              initial={{ opacity: 0, scale: 0.95 }}
              whileInView={{ opacity: 1, scale: 1 }}
              viewport={{ once: true }}
            >
      ...
      <section className="relative py-24 md:py-32 px-4 bg-gradient-to-b from-white to-slate-50 overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-1/4 left-0 w-64 h-64 bg-gradient-to-br from-[#8D36EB]/5 to-transparent rounded-full blur-3xl" />
          <div className="absolute bottom-1/4 right-0 w-64 h-64 bg-gradient-to-br from-[#165CFF]/5 to-transparent rounded-full blur-3xl" />
          ...
          <svg className="absolute inset-0 w-full h-full" viewBox="0 0 1200 800" preserveAspectRatio="xMidYMid slice">
            <defs>
              <linearGradient id="lineGrad1" x1="0%" y1="0%" x2="100%" y2="0%">
                <stop offset="0%" stopColor="#8D36EB" stopOpacity="0" />
                <stop offset="50%" stopColor="#8D36EB" stopOpacity="0.15" />
                <stop offset="100%" stopColor="#165CFF" stopOpacity="0" />
              </linearGradient>
              <linearGradient id="lineGrad2" x1="0%" y1="0%" x2="100%" y2="0%">
                <stop offset="0%" stopColor="#165CFF" stopOpacity="0" />
                <stop offset="50%" stopColor="#165CFF" stopOpacity="0.1" />
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          <motion.h2
            ...
            viewport={{ once: true }}
          >
            {t('axp.venn.title1')}<span className="text-transparent bg-clip-text bg-gradient-to-r from-[#8D36EB] to-[#165CFF]">{t('axp.venn.title2')}</span>{t('axp.venn.title3')}
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#8D36EB] to-[#165CFF]">{t('axp.venn.title4')}</span>{t('axp.venn.title5')}
          </motion.h2>
              ...
              <svg viewBox="0 0 500 480" className="w-full h-full">
                <defs>
                  ...
                  <linearGradient id="centerGradVenn" x1="0%" y1="0%" x2="100%" y2="100%">
                    <stop offset="0%" stopColor="#8D36EB" />
                ...
                >
                  ...
                  <text x="250" y="252" textAnchor="middle" fill="#8D36EB" fontSize="13" fontWeight="600">{t('axp.venn.center1')}</text>
                  <text x="250" y="275" textAnchor="middle" fontSize="20" fontWeight="800">
                    <tspan fill="#8D36EB">A</tspan>
                    <tspan fill="#165CFF">X</tspan>
                  </text>
                </motion.g>
          ...
          >
            <h2 className="text-xl md:text-3xl lg:text-4xl font-bold mb-4 text-foreground">
              <span className="relative inline-block">
                ...
                />
                <span className="relative text-[#8D36EB] font-bold">{t('axp.case.title1')}</span>
              </span>
      ...
      <section className="relative py-16 md:py-32 px-4 bg-gradient-to-b from-slate-50 to-white overflow-hidden">
        <div className="max-w-4xl mx-auto">
          ...
          >
            <h2 className="text-xl md:text-3xl lg:text-4xl font-bold mb-4 text-foreground">
              {t('axp.diff.title1')}<br className="md:hidden" /><span className="text-transparent bg-clip-text bg-gradient-to-r from-[#8D36EB] to-[#165CFF]">{t('axp.diff.title2')}</span>
            </h2>
          </motion.div>
          ...
          >
              ...
              <TableBody>
                {[
                  ...
                  <TableRow key={row.category} className="hover:bg-slate-50/50 md:group-hover:bg-transparent">
                    ...
                    <TableCell className="text-center font-medium text-[#8D36EB] text-[10px] md:text-sm px-2 md:px-4 py-2 md:py-3">{row.ax}</TableCell>
                  </TableRow>
                ))}
              </TableBody>
            </Table>
            ...
            <div className="md:hidden text-center py-2 bg-slate-50 border-t border-slate-100">
              <span className="inline-flex items-center justify-center text-[#8D36EB]">
            ...
            >
              ...
              <div className="sticky top-0 bg-white border-b border-slate-100 px-4 py-3 flex items-center justify-between z-10">
                <h3 className="text-base font-bold text-foreground">
                  {t('axp.diff.title1')}<span className="text-transparent bg-clip-text bg-gradient-to-r from-[#8D36EB] to-[#165CFF]">{t('axp.diff.title2')}</span>
                </h3>
                <button
                  onClick={() => setShowTableModal(false)}
                  ...
                  <TableBody>
                    {[
                      ...
                      <TableRow key={row.category}>
                        ...
                        <TableCell className="text-center font-semibold text-[#8D36EB] text-sm px-3 py-3 bg-[#8D36EB]/5">{row.ax}</TableCell>
                      </TableRow>
                    ))}
                  </TableBody>
                </Table>
                ...
                <form className="space-y-4" onSubmit={(e) => { e.preventDefault(); handleCloseCtaForm(); }}>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-4 py-3 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#8D36EB]/50 focus:border-[#8D36EB]"
                      />
                    </div>
                    <div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full px-4 py-3 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#8D36EB]/50 focus:border-[#8D36EB] resize-none"
                    />
                  </div>
                  ...
                  <Button
                    type="submit"
                    className="w-full bg-gradient-to-r from-[#8D36EB] to-[#165CFF] hover:opacity-90 text-white py-6 text-lg rounded-xl font-bold"
                  >
