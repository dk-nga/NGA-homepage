    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative pt-24 md:pt-28">
        ...
        >
          ...
          >
            <defs>
              <linearGradient id="ngaCasesCurveGrad1" x1="0%" y1="0%" x2="100%" y2="100%">
                <stop offset="0%" stopColor="#8D36EB" stopOpacity="0.3" />
                <stop offset="50%" stopColor="#6B4DE6" stopOpacity="0.2" />
                <stop offset="100%" stopColor="#165CFF" stopOpacity="0.1" />
              </linearGradient>
              <linearGradient id="ngaCasesCurveGrad2" x1="100%" y1="0%" x2="0%" y2="100%">
                <stop offset="0%" stopColor="#165CFF" stopOpacity="0.25" />
                <stop offset="100%" stopColor="#8D36EB" stopOpacity="0.05" />
              </linearGradient>
              <linearGradient id="ngaCasesCurveGrad3" x1="0%" y1="100%" x2="100%" y2="0%">
                <stop offset="0%" stopColor="#8D36EB" stopOpacity="0.2" />
                <stop offset="100%" stopColor="#165CFF" stopOpacity="0.15" />
              </linearGradient>
              <linearGradient id="ngaCasesTriangleGrad" x1="0%" y1="0%" x2="100%" y2="100%">
          ...
          <div className="absolute right-0 top-1/4 h-32 w-32 opacity-10 md:h-48 md:w-48">
            <svg viewBox="0 0 100 100" className="h-full w-full">
              <polygon
                ...
                fill="none"
                stroke="url(#ngaCasesTriangleGrad)"
                strokeWidth="1"
              />
            </svg>
          </div>
          ...
          <div className="relative z-10 mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8 md:py-16">
            ...
            >
              <Button
                ...
                className="rounded-lg bg-gradient-to-r from-[#8D36EB] to-[#165CFF] px-6 py-5 text-sm font-semibold text-white hover:opacity-90 md:text-base"
              >
                {t("cases.downloadCta")}
      ...
      <main className="py-12 md:py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            {language === "ja"
              ? "NextGenAIが見つけた実践的なAI活用事例をご覧ください。"
              : "넥스트젠AI가 찾아본 AI 실전 사례들을 살펴보세요."}
          </motion.p>
          ...
          >
            ...
            >
              <TabsList className="h-auto flex-wrap justify-start gap-1 bg-muted/50 p-1 md:justify-center">
                <TabsTrigger
                  value="all"
                  className="rounded-full px-3 py-1.5 text-xs data-[state=active]:bg-gradient-to-r data-[state=active]:from-[#8D36EB] data-[state=active]:to-[#165CFF] data-[state=active]:text-white md:px-4 md:py-2 md:text-sm"
                >
                  {language === "ja" ? "すべて" : "전체"}
                </TabsTrigger>
                    ...
                    >
                      <Link href={`/blog/${post.slug}`}>
                        ...
                        <div className="space-y-3 p-5">
                          ...
                          <h2 className="line-clamp-2 text-xl font-bold text-foreground transition-all group-hover:bg-gradient-to-r group-hover:from-[#8D36EB] group-hover:to-[#165CFF] group-hover:bg-clip-text group-hover:text-transparent">
                            {post.title}
                          </h2>
                  ...
                  <div className="flex items-center gap-1">
                    {Array.from({ length: totalPages }, (_, index) => index + 1).map((page) => (
                      <Button
                        ...
                        className={
                          currentPage === page
                            ? "h-10 w-10 border-none bg-gradient-to-r from-[#8D36EB] to-[#165CFF] text-white"
                            : "h-10 w-10"
                        }
                      >
                        {page}
          ...
          <div className="grid items-center gap-12 md:grid-cols-2">
            ...
            >
              ...
              <h2 className="mb-8 text-3xl leading-tight font-bold md:text-4xl">
                <span className="bg-gradient-to-br from-[#8D36EB] to-[#165CFF] bg-clip-text text-transparent">
                  {t("cases.ctaTitle2")}
                </span>
              </h2>
              <Button
                ...
                className="bg-gradient-to-r from-[#8D36EB] to-[#165CFF] px-8 font-semibold text-white hover:opacity-90"
              >
                {t("cases.ctaButton")}
              </Button>
            </motion.div>
