  ...
  return (
    ...
    >
      ...
      <div className="bg-white/50 backdrop-blur-xl rounded-xl md:rounded-2xl p-4 md:p-6 border border-white/60 shadow-lg transition-all duration-300 min-h-[180px] md:min-h-[220px] flex flex-col">
        {/* Number - Plain text */}
        <span className="text-xl md:text-2xl font-extrabold bg-gradient-to-r from-[#8D36EB] to-[#165CFF] bg-clip-text text-transparent mb-2 md:mb-3 drop-shadow-sm">
          0{number}
        </span>
      ...
      >
        <div className="bg-white/95 backdrop-blur-xl rounded-2xl p-5 border border-[#8D36EB]/20 shadow-2xl h-full flex">
          {/* Left side - Content */}
          <div className="flex flex-col flex-1 pr-3">
            {/* Pain Point Label */}
            <span className="text-[10px] md:text-xs font-bold text-[#8D36EB] tracking-wide mb-0.5 md:mb-1">Pain Point</span>
            
            {/* Number */}
            <span className="text-lg md:text-xl font-extrabold bg-gradient-to-r from-[#8D36EB] to-[#165CFF] bg-clip-text text-transparent mb-2 md:mb-3">
              0{number}
            </span>
    ...
    >
      ...
      <div className="bg-white/80 backdrop-blur-sm rounded-xl md:rounded-2xl overflow-hidden h-full shadow-sm transition-all hover:shadow-lg hover:shadow-[#8D36EB]/5">
        ...
        <div className="p-4 md:p-6">
          <div className="w-7 h-7 md:w-9 md:h-9 rounded-lg bg-gradient-to-br from-[#8D36EB]/10 to-[#165CFF]/10 flex items-center justify-center mb-3 md:mb-4">
            <program.icon className="w-3 h-3 md:w-4 md:h-4 text-[#8D36EB]" />
          </div>
            ...
            <div className="w-full h-64 bg-gradient-to-br from-[#1a1a3a] to-[#0d0d24] overflow-hidden">
              {instructor.image ? (
                ...
                <div className="w-full h-full flex items-center justify-center">
                  <div className="w-24 h-24 rounded-full bg-gradient-to-br from-[#8D36EB]/30 to-[#165CFF]/30 flex items-center justify-center">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        >
          <div className="flex items-center gap-0.5">
            ...
            <span className={`px-3 py-1.5 text-xs font-semibold rounded-full transition-all duration-300 ${
              showAfter 
                ? 'bg-gradient-to-r from-[#8D36EB] to-[#165CFF] text-white shadow-md' 
                : 'text-gray-400'
            }`}>
              After
            </span>
                ...
                <motion.div 
                  ...
                  animate={{ 
                    ...
                    background: showAfter 
                      ? 'linear-gradient(90deg, #8D36EB 0%, #165CFF 100%)' 
                      : '#D0D0D0'
                  }}
                  transition={{ 
                    duration: 0.6, 
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center max-w-7xl mx-auto lg:mx-0 lg:ml-auto">
            ...
            <div className="text-center lg:text-left lg:pl-8 xl:pl-16">
              ...
              <motion.div
                ...
                className="inline-flex items-center gap-2 px-4 py-1.5 bg-white/70 border border-[#8D36EB]/15 rounded-full mb-6 backdrop-blur-sm shadow-sm"
              >
                <img src={nextgenSymbol.src} alt="NextGen AI" className="w-5 h-5" />
              ...
              >
                <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold min-h-[80px] md:min-h-[100px] text-foreground leading-tight">
                      ...
                      <span key={index}>
                        ...
                        {index < arr.length - 1 && (
                          <span className="relative inline">
                            <span className="absolute inset-0 bg-gradient-to-r from-[#8D36EB]/25 to-[#165CFF]/25 -skew-x-1 rounded-sm" style={{ top: '15%', bottom: '10%' }} />
                  ...
                  <motion.span
                    ...
                    className="inline-block w-0.5 h-8 md:h-10 bg-[#165CFF] ml-1 align-middle"
                  />
                </h1>
              </motion.div>
                  ...
                  >
                    ...
                    <div className="flex flex-row gap-2 sm:gap-4 justify-center lg:justify-start items-center">
                      ...
                      <motion.button
                        ...
                        className="group relative inline-flex items-center gap-1 sm:gap-2 px-3 sm:px-8 py-2 sm:py-4 rounded-full font-semibold text-[11px] sm:text-base overflow-hidden shadow-lg shadow-[#8D36EB]/25"
                        style={{ background: 'linear-gradient(135deg, #8D36EB 0%, #165CFF 100%)' }}
                      ...
                      <motion.button
                        ...
                        className="inline-flex items-center gap-1 sm:gap-2 px-3 sm:px-8 py-2 sm:py-4 bg-white/80 border border-[#8D36EB]/20 text-foreground rounded-full font-semibold text-[11px] sm:text-base hover:bg-white transition-all backdrop-blur-sm whitespace-nowrap"
                        whileHover={{ scale: 1.05 }}
                        whileTap={{ scale: 0.98 }}
                      >
                        {t("edu.ctaSecondary")}
            ...
            >
              ...
              >
                {/* Front - Chart Card */}
                <div 
                  className="bg-white/90 backdrop-blur-md rounded-xl p-5 shadow-xl shadow-[#8D36EB]/10 border border-white/50"
                ...
                >
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="flex items-center gap-3 text-xs">
                      ...
                      <div className="flex items-center gap-1.5">
                        <div className="w-2.5 h-2.5 rounded-full bg-gradient-to-r from-[#8D36EB] to-[#165CFF]" />
                    ...
                    {[
                      ...
                      <div key={index} className="space-y-1.5">
                        <div className="flex justify-between items-center">
                          ...
                          <span className="text-xs font-bold text-[#8D36EB]">+{item.after - item.before}%</span>
                        </div>
                        <div className="relative h-6 flex gap-0.5">
                          ...
                          <motion.div 
                            className="h-full bg-gradient-to-r from-[#8D36EB] to-[#165CFF] rounded-md relative overflow-hidden"
                            initial={{ width: 0 }}
                  ...
                  >
                    ...
                    <span className="text-xs font-medium text-foreground">
                      {t("edu.chartSummary")} <span className="text-[#8D36EB] font-bold">+68%</span>
                    </span>
                  </motion.div>
                </div>
                ...
                <div 
                  className="absolute inset-0 bg-gradient-to-br from-[#8D36EB] to-[#165CFF] rounded-xl p-6 shadow-xl flex flex-col items-center justify-center text-center"
          ...
          >
            ...
            >
              <div className="flex items-baseline justify-center mb-2">
                <span className="text-4xl md:text-5xl font-black bg-gradient-to-r from-[#8D36EB] to-[#165CFF] bg-clip-text text-transparent">
                  {satisfactionCount}
                </span>
                <span className="text-lg md:text-xl font-bold bg-gradient-to-r from-[#8D36EB]/60 to-[#165CFF]/60 bg-clip-text text-transparent">
      ...
      <section className="py-24 bg-[#E8ECFF] relative overflow-hidden">
        <div className="container mx-auto px-6 relative z-10">
          ...
          >
            <h2 className="text-xl md:text-4xl font-bold text-foreground">
              ...
              <span className="relative inline-block mt-2">
                <span className="absolute inset-0 bg-gradient-to-r from-[#8D36EB]/20 to-[#165CFF]/20 -skew-x-1 rounded-sm" style={{ top: '10%', bottom: '5%' }} />
          ...
          >
            ...
            >
              <ChevronDown className="w-8 h-8 text-[#8D36EB]" strokeWidth={2.5} />
              <ChevronDown className="w-8 h-8 text-[#165CFF] -mt-4" strokeWidth={2.5} />
            </motion.div>
          </motion.div>
                ...
                >
                  <defs>
                    <linearGradient id="curveGradient1" x1="0%" y1="0%" x2="100%" y2="100%">
                      <stop offset="0%" stopColor="#8D36EB" stopOpacity="0.6" />
                      <stop offset="100%" stopColor="#165CFF" stopOpacity="0.3" />
                    </linearGradient>
                    <linearGradient id="curveGradient2" x1="0%" y1="0%" x2="100%" y2="100%">
                      <stop offset="0%" stopColor="#165CFF" stopOpacity="0.5" />
                      <stop offset="100%" stopColor="#8D36EB" stopOpacity="0.2" />
                    </linearGradient>
                    {/* Blur/Glow filters */}
              ...
              >
                ...
                <div className="relative h-24 md:h-32 overflow-hidden">
                  ...
                  <div className="absolute bottom-2 md:bottom-3 left-3 md:left-4 w-7 h-7 md:w-9 md:h-9 rounded-full bg-white/90 backdrop-blur-sm flex items-center justify-center shadow-lg ring-1 ring-black/5">
                    <item.icon className="w-3 h-3 md:w-4 md:h-4 text-[#8D36EB]" />
                  </div>
                </div>
                ...
                <div className="p-4 md:p-6">
                  ...
                  <div className="flex items-center gap-2 mb-1 md:mb-2">
                    <span className="px-2 py-0.5 text-[10px] md:text-xs font-medium rounded-full bg-[#8D36EB]/10 text-[#8D36EB]">Solution</span>
                  </div>
                  <h3 className="text-sm md:text-base font-bold mb-2 md:mb-3 flex items-center gap-1 md:gap-2">
                    <ChevronRight className="w-3 h-3 md:w-4 md:h-4 text-[#8D36EB]" />
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          >
            <motion.div
              ...
              transition={{ duration: 1.5, repeat: Infinity, ease: "easeInOut" }}
            >
              <ChevronDown className="w-8 h-8 text-[#8D36EB]" strokeWidth={2} />
            </motion.div>
          </motion.div>
          ...
          >
            ...
            >
              <h4 className="font-bold mb-2 md:mb-3 flex items-center gap-2 text-sm md:text-base">
                <Shield className="w-4 h-4 md:w-5 md:h-5 text-[#8D36EB]" />
            ...
            >
              <h4 className="font-bold mb-2 md:mb-3 flex items-center gap-2 text-sm md:text-base">
                <Target className="w-4 h-4 md:w-5 md:h-5 text-[#165CFF]" />
                  ...
                  <div className="relative aspect-square max-w-[260px] mx-auto">
                    <svg viewBox="0 0 200 200" className="w-full h-full">
                      ...
                      <defs>
                        <linearGradient id="radarGradient" x1="0%" y1="0%" x2="100%" y2="100%">
                          ...
                          <stop offset="100%" stopColor="#165CFF" stopOpacity="0.2" />
                        </linearGradient>
                    ...
                    {[
                      ...
                      <div key={i} className={`absolute ${item.pos} text-center`}>
                        ...
                        <span className="text-xs font-bold text-[#8D36EB]">{item.value}</span>
                      </div>
                    ))}
                  </div>
                </motion.div>
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm font-medium text-foreground">
                    {t('edu.evidence.avgImprovement')} <span className="text-[#8D36EB] font-bold text-lg">+68%</span>
                  </span>
                </div>
                <div className="flex items-center gap-2">
                  <TrendingUp className="w-5 h-5 text-blue-500" />
                  <span className="text-sm font-medium text-foreground">
                    {t('edu.evidence.productivity')} <span className="text-[#165CFF] font-bold text-lg">+45%</span>
                  </span>
                </div>
                <div className="flex items-center gap-2">
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          >
            ...
            <div className="flex flex-row gap-2 sm:gap-4 justify-center">
              <motion.button
                onClick={handlePrimaryCTA}
                className="group relative inline-flex items-center gap-1 sm:gap-3 px-4 sm:px-10 py-2.5 sm:py-5 rounded-full font-bold text-xs sm:text-lg overflow-hidden shadow-2xl shadow-[#8D36EB]/30"
                style={{ background: 'linear-gradient(135deg, #8D36EB 0%, #165CFF 100%)' }}
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.98 }}
              >
