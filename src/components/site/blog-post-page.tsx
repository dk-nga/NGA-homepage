              ...
              <>
                  ...
                  {post.tags && post.tags.length > 0 && (
                    <div className="mb-4 flex flex-wrap gap-2">
                      {post.tags.map((tag) => (
                        <span
                          key={tag.id}
                          className="rounded-full bg-gradient-to-r from-[#8D36EB]/10 to-[#165CFF]/10 px-3 py-1 text-xs font-medium text-[#5D43D6]"
                        >
                          {tag.name}
                        </span>
                      ))}
                ...
                <motion.div
                  ...
                  className={cn(
                    ...
                    "prose-blockquote:my-8 prose-blockquote:rounded-r-lg prose-blockquote:border-l-4 prose-blockquote:border-[#8D36EB] prose-blockquote:bg-muted/30 prose-blockquote:py-1 prose-blockquote:pl-6 prose-blockquote:italic prose-blockquote:text-muted-foreground",
