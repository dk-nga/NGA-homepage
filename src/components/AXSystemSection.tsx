      ...
      >
        <div className="flex h-full">
          ...
          <div className="flex-1 pl-9 md:pl-24 pr-3 md:pr-8 lg:pr-[300px] py-4 md:py-16 flex flex-col justify-center relative">
            ...
            >
              <CurlyQuote className="w-5 h-5 md:w-16 md:h-16 text-[#8D36EB]/30" isOpen={true} />
            </motion.div>
            ...
            >
              <CurlyQuote className="w-6 h-6 md:w-16 md:h-16 text-[#165CFF]/30" isOpen={false} />
            </motion.div>
          </div>
              ...
              <div className="p-4 bg-white border-t border-[#e8e8ec]">
                <AnimatePresence mode="wait">
                  ...
                  >
                    ...
                    <div className="w-10 h-10 rounded-full bg-gradient-to-r from-[#8D36EB]/10 to-[#165CFF]/10 flex items-center justify-center flex-shrink-0">
                      <span className="text-xs font-bold bg-gradient-to-r from-[#8D36EB] to-[#165CFF] bg-clip-text text-transparent">
          ...
          return (
            ...
            >
              ...
              <div className="relative p-3 md:p-10 rounded-2xl md:rounded-3xl text-center overflow-hidden backdrop-blur-sm bg-gradient-to-br from-white/10 to-white/5 border border-white/20 shadow-[0_8px_32px_rgba(141,54,235,0.1)] hover:shadow-[0_8px_32px_rgba(141,54,235,0.2)] transition-all duration-300">
                {/* Inner glow effect */}
                <div className="absolute inset-0 bg-gradient-to-br from-[#8D36EB]/5 via-transparent to-[#165CFF]/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                
                {/* Bubble highlight */}
                <div className="absolute -top-4 -left-4 w-16 h-16 bg-white/10 rounded-full blur-xl" />
                <div className="absolute -bottom-8 -right-8 w-24 h-24 bg-gradient-to-br from-[#8D36EB]/10 to-[#165CFF]/10 rounded-full blur-2xl" />
                
                {/* Content */}
                <div className="relative z-10">
                  <div className="text-2xl md:text-6xl font-black mb-1 md:mb-2 bg-gradient-to-r from-[#8D36EB] to-[#165CFF] bg-clip-text text-transparent">
...
const MobileAllSteps = ({ steps }: { steps: StepType[] }) => {
  ...
  return (
    ...
    >
      ...
      <svg className="absolute inset-0 w-full h-full pointer-events-none" preserveAspectRatio="none">
        <defs>
          <linearGradient id="mobileCurveGradient" x1="0%" y1="0%" x2="100%" y2="100%">
            <stop offset="0%" stopColor="#8D36EB" stopOpacity="0.12" />
            <stop offset="100%" stopColor="#165CFF" stopOpacity="0.12" />
          </linearGradient>
        </defs>
        <motion.path
      ...
      {/* Floating orbs */}
      <div className="absolute -top-24 -right-24 w-48 h-48 rounded-full bg-[#8D36EB]/10 blur-3xl pointer-events-none" />
      <div className="absolute -bottom-20 -left-20 w-40 h-40 rounded-full bg-[#165CFF]/10 blur-3xl pointer-events-none" />
  ...
  return (
    <section ref={sectionRef} id="partners" className="relative bg-background">
      ...
      <div className="h-screen flex items-center relative overflow-hidden overflow-x-hidden snap-start snap-always">
        ...
        <svg className="absolute inset-0 w-full h-full pointer-events-none" preserveAspectRatio="none">
          <defs>
            <linearGradient id="curveGradient" x1="0%" y1="0%" x2="100%" y2="100%">
              <stop offset="0%" stopColor="#8D36EB" stopOpacity="0.15" />
              <stop offset="100%" stopColor="#165CFF" stopOpacity="0.15" />
            </linearGradient>
          </defs>
          <motion.path
        ...
        {/* Floating orbs */}
        <FloatingOrb color="#8D36EB" size="w-[500px] h-[500px]" position="-top-48 -right-48" />
        <FloatingOrb color="#165CFF" size="w-[400px] h-[400px]" position="-bottom-32 -left-32" />
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10 overflow-hidden">
          ...
          >
            {/* Framework badge */}
            <motion.div 
              className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-[#8D36EB]/10 to-[#165CFF]/10 border border-[#8D36EB]/20 mb-6"
              variants={itemVariants}
            >
              <span className="text-[#8D36EB] font-bold text-sm">NextGen AX Framework™</span>
            </motion.div>
            ...
            <motion.h2 
              ...
              variants={itemVariants}
            >
              <span className="bg-gradient-to-r from-[#8D36EB] to-[#165CFF] bg-clip-text text-transparent">{t("ax.intro.title1")}</span>{t("ax.intro.title2")}{" "}
              <span className="px-2 py-0.5 md:px-3 md:py-1 rounded-lg bg-gradient-to-r from-[#8D36EB] to-[#165CFF] text-white">{t("ax.intro.title3")}</span>{t("ax.intro.title4")}
            </motion.h2>
            ...
            >
              ...
              <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-bl from-[#8D36EB]/10 to-transparent rounded-bl-full" />
              <div className="absolute bottom-0 left-0 w-24 h-24 bg-gradient-to-tr from-[#165CFF]/10 to-transparent rounded-tr-full" />
              ...
              <p className="text-xs sm:text-sm md:text-lg lg:text-xl text-center font-medium leading-relaxed relative z-10">
                ...
                <span className="bg-gradient-to-r from-[#8D36EB] to-[#165CFF] bg-clip-text text-transparent font-bold">{t("ax.intro.box3")}</span> {t("ax.intro.box4")}
      ...
      <div className="min-h-screen flex items-center py-24 relative overflow-hidden overflow-x-hidden snap-start snap-always">
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10 pt-8 overflow-hidden">
          ...
          >
            ...
            >
              {t("ax.part3.title1")}{" "}
              <span className="bg-gradient-to-r from-[#8D36EB] to-[#165CFF] bg-clip-text text-transparent">{t("ax.part3.title2")}</span>{t("ax.part3.title3")}
            </motion.h2>
            <motion.p 
            ...
            <div className="grid md:grid-cols-3 gap-4 md:gap-6">
              {translatedDifferentiators.map((item, index) => (
                ...
                >
                  ...
                  {/* Decorative arc */}
                  <div className="absolute -bottom-24 -right-24 h-48 w-48 rounded-full border border-slate-400/8 transition-colors duration-500 group-hover:border-[#8D36EB]/10" />
                  
                  {/* Content */}
                  <div className="relative z-10">
                    {/* Number indicator */}
                    <div className="flex items-center gap-2 mb-4">
                      <div className="w-9 h-9 rounded-full bg-gradient-to-br from-[#8D36EB] via-[#6B4DE6] to-[#165CFF] flex items-center justify-center text-white font-bold text-xs shadow-lg shadow-[#8D36EB]/25">
                        {String(index + 1).padStart(2, '0')}
                      </div>
                      <div className="h-px flex-1 bg-gradient-to-r from-[#8D36EB]/18 to-transparent" />
                    </div>
          ...
          >
            ...
            >
              <ChevronDown className="w-7 h-7 text-[#8D36EB]/40" strokeWidth={2.5} />
              <ChevronDown className="w-7 h-7 text-[#165CFF]/25" strokeWidth={2} />
            </motion.div>
          </motion.div>
