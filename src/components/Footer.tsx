...
export function Footer() {
  return (
    <footer className="snap-start overflow-hidden bg-black py-12 text-white/70">
      <div className="container mx-auto overflow-hidden px-4 md:px-6">
        <div className="mb-12 grid gap-8 md:grid-cols-4">
          <div className="md:col-span-2">
            ...
            <p className="mb-4 max-w-md whitespace-pre-line text-white/50">
          ...
          <div>
            <h4 className="mb-4 font-bold text-white">회사</h4>
            <ul className="space-y-2 text-white/50">
              <li>회사소개</li>
              <li>블로그</li>
        ...
        <div className="flex flex-col items-center justify-between gap-4 border-t border-white/10 pt-8 md:flex-row">
          <p className="text-xs text-white/30">© Copyrights by NextGen AI. All Rights Reserved.</p>
