...
const orbitRings = [
  { className: "-inset-[5%]", border: "rgba(141, 54, 235, 0.16)", duration: 22 },
  { className: "-inset-[9%]", border: "rgba(22, 92, 255, 0.12)", duration: 28 },
];

const accentArcs = [
  {
    className: "-bottom-[8%] left-[2%] h-[24%] w-[40%]",
    borderColor: "rgba(141, 54, 235, 0.34)",
    rotate: -20,
  },
  {
    className: "-bottom-[10%] right-[4%] h-[22%] w-[36%]",
    borderColor: "rgba(22, 92, 255, 0.28)",
    rotate: 18,
  },
  {
  ...
  return (
    ...
    >
      <motion.div
        ...
        style={{
          background:
            "radial-gradient(circle at 34% 28%, rgba(255,255,255,0.18) 0%, rgba(182,150,255,0.18) 12%, rgba(80,54,170,0.9) 38%, rgba(38,27,81,0.98) 68%, rgba(15,10,32,1) 100%)",
          boxShadow:
            "0 0 0 10px rgba(255,255,255,0.8), 0 0 0 18px rgba(191, 219, 254, 0.2), 0 35px 80px rgba(56, 189, 248, 0.16), 0 12px 34px rgba(15, 23, 42, 0.24)",
        }}
        animate={{
      ...
      >
        ...
        <div className="absolute inset-[7.5%] rounded-full border border-slate-300/20" />
        ...
        <div
          ...
          style={{
            background:
              "conic-gradient(from 210deg at 52% 50%, rgba(9,13,40,0.82), rgba(45,33,92,0.18), rgba(127,90,213,0.55), rgba(36,26,67,0.9), rgba(9,13,40,0.82))",
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(140deg, rgba(255,255,255,0.08), rgba(91, 33, 182, 0.04) 35%, rgba(15,23,42,0.55) 100%)",
      ...
      <motion.div
        ...
        style={{
          background:
            "radial-gradient(circle, rgba(103,232,249,0.14) 0%, rgba(96,165,250,0.16) 30%, rgba(129,140,248,0.1) 52%, transparent 72%)",
        }}
        animate={{
      ...
      <div className="pointer-events-none absolute inset-0">
        {[
          ...
          <motion.span
            key={position}
            className={`absolute h-[7%] w-px rounded-full bg-gradient-to-b from-transparent via-[#c084fc] to-transparent ${position}`}
      ...
      {isSpeaking ? (
        <div className="absolute bottom-[4%] left-1/2 flex -translate-x-1/2 items-end gap-[3px]">
          {Array.from({ length: 7 }).map((_, index) => (
            <motion.div
              key={index}
              className="rounded-full bg-gradient-to-b from-[#67e8f9] via-[#818cf8] to-[#8D36EB]"
