            ...
            >
              ...
              <div className="flex-1 overflow-y-auto p-4 md:p-6">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-3 md:space-y-4">
                  ...
                  <div className="space-y-3 rounded-xl border border-gray-100 bg-gray-50/70 p-3 md:p-4">
                    <Controller
                      name="privacyAgree"
                      control={control}
                      render={({ field }) => (
                  ...
                  <button
                    ...
                    className="flex h-11 w-full items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-[#8D36EB] to-[#165CFF] px-4 text-sm font-semibold text-white transition-opacity hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-70"
                  >
