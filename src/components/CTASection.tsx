...
export function CTASection() {
  ...
  return (
    <section id="about" className="relative flex min-h-screen items-center overflow-hidden overflow-x-hidden py-24">
      <div className="absolute inset-0 bg-gradient-to-br from-[#8D36EB]/10 via-background to-[#165CFF]/10" />
      <motion.div
        className="absolute top-1/4 -left-32 h-64 w-64 rounded-full bg-[#8D36EB]/20 blur-3xl"
        animate={{ opacity: [0.3, 0.5, 0.3], scale: [1, 1.2, 1] }}
        transition={{ duration: 6, ease: "easeInOut", repeat: Infinity }}
      />
      <motion.div
        className="absolute bottom-1/4 -right-32 h-80 w-80 rounded-full bg-[#165CFF]/20 blur-3xl"
