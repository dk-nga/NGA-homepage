...
export function NewsSection() {
  ...
  return (
    <section className="relative overflow-hidden overflow-x-hidden bg-[#0d0d24] pb-24 pt-8 md:pb-32 md:pt-12">
            ...
            >
              <div className="relative rounded-xl border border-white/10 bg-white/5 p-4 backdrop-blur-sm transition-all duration-300 hover:border-white/30 hover:bg-white/10 md:rounded-2xl md:p-8">
                <div className="mb-2 flex items-center gap-2 md:mb-4 md:gap-3">
                  ...
                  <span className="rounded-full bg-gradient-to-r from-[#8D36EB] to-[#165CFF] px-3 py-1 text-xs font-medium text-white md:px-4 md:py-1.5 md:text-sm">
                    {item.category}
                  </span>
                </div>
                <div className="flex items-center justify-between gap-3 md:gap-4">
                  <h3 className="line-clamp-2 text-sm font-medium text-white transition-all duration-300 group-hover:text-[#8D36EB] md:text-xl">
                    {item.title}
                  </h3>
                  <ChevronRight className="h-5 w-5 flex-shrink-0 text-white/40 transition-all duration-300 group-hover:translate-x-1 group-hover:text-[#8D36EB] md:h-6 md:w-6" />
                </div>
              </div>
            </motion.a>
          ))}
